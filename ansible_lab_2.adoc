...
. *Review the lab2-windows-repo Project*
+
Begin by navigating to the _Projects_ view and click on the `lab2-windows-repo` lab link to review its settings.
+
image::lab2_000003_review_project.png[]
+
Review the _New Project_ form taking note of the following information:
+
.. *Name* - `lab2-windows-repo`.
.. *Organization* - `sid-org`
+
[IMPORTANT]
====
