...
To set up the labs you will need to ssh into `{jumphost}` and execute the lab setup command.
...
click here to move onto lab1:  https://github.com/mysidlabs/ansible-labs-adoc/blob/windows/ansible_lab_1.adoc
