...
----
siduser270@toolkit ~/dev/ansible/lab1 # ansible-playbook clean.yaml --ask-vault-pass
Vault password:
...
click here to move onto lab 2:  https://github.com/mysidlabs/ansible-labs-adoc/blob/windows/ansible_lab_2.adoc
